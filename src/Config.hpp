...
#define DEFAULT_TMDET_BALL_DIST "0.20"
...
#define TMDET_MINIMUM_QVALUE 45
#define TMDET_MEMBRANE_QVALUE 35
#define TMDET_MEMBRANE_MIN_HALFTHICKNESS 6
#define TMDET_MEMBRANE_MAX_HALFTHICKNESS 17
#define TMDET_REENTRANT_LOOP_MIN_LENGTH 10
